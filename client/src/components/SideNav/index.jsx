  ...
  return (
    ...
    >
      ...
      >
        ...
        <Menu.Item key="" icon={<DiffOutlined />}>
          {/* <NavLink to="">Job portal</NavLink> */}
          <a href='https://job-portal-teal.vercel.app/'>
            Job Updates
          </a>
        </Menu.Item>
        <Menu.Item key="" icon={<  PullRequestOutlined />}>
          {/* <NavLink to="">Live Class</NavLink> */}
          <a href='https://devsync.vercel.app/'>
            Devsync Live Class 
          </a>
        </Menu.Item>
        <Menu.Item key="" icon={<ReadOutlined />}>
          {/* <NavLink to="https://bit.ly/freelms-eduhub">Live Class</NavLink> */}
          <a href='https://bit.ly/freelms-eduhub'>
            Free Edu-Hub
          </a>
        </Menu.Item>
